...
const config = {
  SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~LdAqjIk0YysTTPUnwkym",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "🍂 TOPBOUY 💦🥵🍂",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254112386921",
